      ...
      <div className=" row row-cols-1 row-cols-md-3 g-3">
          ...
          <div className="card h-100">
            ...
            <div className="card-body">
              <h6 className="card-title">
                Inclus�o e acessibilidade: Fl�vio Arruda at TEDxFortaleza
              </h6>
            </div>
          </div>
        </div>
        <div className="col">
          <div className="card h-100">
            ...
            <div className="card-body">
              <h6 className="card-title">
                Especial acessibilidade: Inclus�o no mercado de trabalho.
              </h6>
            </div>
          </div>
        </div>
        <div className="col">
          <div className="card h-100">
            ...
            <div className="card-body">
              <h6 className="card-title">
                Inclus�o de Pessoas com Defici�ncia no mercado de trabalho
              </h6>
            </div>
          </div>
        </div>
        <div className="col">
          <div className="card h-100">
            ...
            <div className="card-body">
              <h6 className="card-title">
                A Inclus�o do Deficiente no Mercado de Trabalho | Ana Silvia
                Marcatto Begalli
              </h6>
            </div>
          </div>
    ...
    <div className="card-group container">
      <div className="row row-cols-1 row-cols-md-4 g-3 text-center">
        <div className="col">
          <div className="card h-100 shadow align-items-center pt-3">
            ...
            <div className="card-body">
              ...
              <i className="bi bi-star-fill" />
              <h6 className="card-title">
                Roda Viva: Mem�rias de um cadeirante
              </h6>
              <p className="card-text">
                <small className="text-body-secondary">
                  Por Jos� Carlos Morais
                </small>
              </p>
            </div>
          </div>
        ...
        <div className="col">
          <div className="card h-100 shadow align-items-center pt-3">
            ...
            <div className="card-body">
              ...
              <i className="bi bi-star-fill" />
              <i className="bi bi-star-fill" />
              <h6 className="card-title">Ainda sou eu. Mem�rias</h6>
              <p className="card-text">
                <small className="text-body-secondary">
        ...
        <div className="col">
          <div className="card h-100 shadow align-items-center pt-3">
            ...
            <div className="card-body">
              ...
              <i className="bi bi-star-fill" />
              <i className="bi bi-star-fill" />
              <h6 className="card-title">Devo��o</h6>
              <p className="card-text">
                <small className="text-body-secondary">
        ...
        <div className="col">
          <div className="card h-100 shadow align-items-center pt-3">
            ...
            <div className="card-body">
              ...
              <i className="bi bi-star-fill" />
              <i className="bi bi-star-fill" />
              <h6 className="card-title">Do outro lado do sol</h6>
              <p className="card-text">
                <small className="text-body-secondary">Por Katia Yuriko</small>
              </p>
            </div>
          </div>
        </div>
        <div className="col">
          <div className="card h-100 shadow align-items-center pt-3">
            <img
              src="/img/img-livros/saga de campe�o.jpg"
              className="card-img-top"
              alt="..."
              style={{ maxHeight: 220, maxWidth: 120 }}
            />
            <div className=" card-body">
              ...
              <i className="bi bi-star-fill" />
              <i className="bi bi-star-fill" />
              <h6 className="card-title">A saga de um campe�o</h6>
              <p className="card-text">
                <small className="text-body-secondary">Por Lars Grael</small>
              </p>
            </div>
          </div>
        </div>
        <div className="col">
          <div className="card h-100 shadow align-items-center pt-3">
            ...
            <div className=" card-body">
              ...
              <i className="bi bi-star-fill" />
              <i className="bi bi-star" />
              <h6 className="card-title">Salvando meu filho</h6>
              <p className="card-text">
                <small className="text-body-secondary">Por Richard Galli</small>
              </p>
            </div>
          </div>
        </div>
        <div className="col">
          <div className="card h-100 shadow align-items-center pt-3">
            ...
            <div className=" card-body">
              ...
              <i className="bi bi-star-fill" />
              <i className="bi bi-star" />
              <h6 className="card-title">Feliz ano velho</h6>
              <p className="card-text">
                <small className="text-body-secondary">
        ...
        <div className="col">
          <div className="card h-100 shadow align-items-center pt-3">
            ...
            <div className=" card-body">
              ...
              <i className="bi bi-star-fill" />
              <i className="bi bi-star-fill" />
              <h6 className="card-title">Pai de rodinhas</h6>
              <p className="card-text">
                <small className="text-body-secondary">
                  Por S�rgio Nardini
                </small>

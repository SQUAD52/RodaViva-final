        ...
        <main style={{ paddingTop: 100 }} className="container-fluid">
            <div className="row">
                <div className="col-sm-12">
                    <div className="card card-primary card-outline cardTalentoCinza">
                        <div className="card-body box-profile">
                            ...
                            <h4 className="profile-username text-center">{talento.nome}</h4>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div className="col-sm-8">
                            <div className="row">
                                <div className="col-sm-6">
                                    <div className="card card-primary cardTalentoCinza alinhaCards">
                                        <div className="card-header cardTalentoBlue">
                                        ...
                                        <div className="card-body">
                                            ...
                                            <strong><i className="fas fa-id-card "></i> CPF</strong>
                                            <p className="text-muted">
                                                {talento.cpf}
                                            </p>
                                            ...
                                            <strong><i className="fas fa-calendar-alt "></i> Data de Nascimento</strong>
                                            <p className="text-muted">
                                                {talento.dataNasc}
                                            </p>
                                ...
                                <div className="col-sm-12 mt-1">
                                    <div className="card card-primary cardTalentoCinza alinhaCards">
                                        <div className="card-header cardTalentoGreen text-white">
                                            <h4 className="card-title text-center">Formação</h4>
                                        </div>
                                        <div className="card-body fa fa-graduation-cap">
                                        <p className="text-muted">{talento.formacao}</p>
                        ...
                        <div className="col-sm-4">
                            <div className="card card-primary cardTalentoCinza alinhaCards">
                                ...
                                <div className="card-body">
                                    ...
                                    <p className="text-muted">{talento.bairro}</p>

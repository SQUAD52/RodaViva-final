      ...
      <main className={`${styles.main} ${inter.className}`}>
        <section className="container mb-5" style={{ marginTop: 90 }}>
          <div className="container">
            ...
            <p className="mt-3">
              Aqui você pode encontrar os melhores talentos, contribua com
              diversidade e competitividade no mercado de trabalho.
            </p>
          </div>
          <div className="btn-group gap-1 flex-wrap mt-5">
            <a href="Cadastro.html">
              <button type="button" className="btn btn-light border-black">
          ...
          <div className="card-group gap-2">
            <div className="card border-0">
              <div className="card-body">
                <h4 className="text-center">Equipes remotas sob medida</h4>
                <p className="card-text">
                  Profissionais de TI especialistas são recrutados e
                  apresentados em menos tempo pelas empresas para se juntarem à
            ...
            <div className="card border-0">
              <div className="card-body">
                <h4 className="text-center">Talentos qualificados</h4>
                <p className="card-text">
                  Profissionais independentes se integraram a diversas equipes
                  para colaborar em projetos a longo prazo, permitindo que o
                  negócio ganhe escala.
                </p>
              </div>
            </div>
            <div className="card border-0">
              <div className="card-body">
                <h4 className="text-center">Variedade de habilidades</h4>
                <p className="card-text">
                  Encontra-se o aliado estratégico para incorporar talentos
                  super especializados à sua empresa, com perfis específicos por
                  área e localidade.
                </p>
              </div>
            </div>
            <div className="card border-0">
              <div className="card-body">
                <h4 className="text-center">Escalabilidade e agilidade</h4>
                <p className="card-text">
                  Os melhores talentos independentes trabalham em parceria com
                  as equipes de diversas áreas diferentes em todos os níveis: de
                  junior a senior.
                </p>
              </div>
            </div>
        ...
        <section className="container bg-black py-5 mb-5">
          <h3 className="text-light text-center mb-5">
            Descubra especialista com as habilidades que você precisa
          </h3>
          <img
            src="./img/img.jpg"
          ...
          <div className="card-body mt-5">
            ...
            <h5 className="card-title text-light my-4">Design</h5>
            <button
              type="button"
              className="btn btn-outline-light rounded-pill fs-sm m-1 p-2"
            >
            ...
            <h5 className="card-title text-light my-4">Marketing</h5>
            <button
              type="button"
              className="btn btn-outline-light rounded-pill fs-sm m-1 p-2"
            >
          ...
          <div className="card-group text-center">
            ...
            <div className="card mb-3 border-0">
              <div className="card-body">
                ...
                <p className="card-text">Candidatos contratados</p>
              </div>
            </div>
            <div className="card mb-3 border-0">
              <div className="card-body">
                <h2 className="card-title">50</h2>
                <p className="card-text">Empresas participantes</p>
              </div>
            </div>
            <div className="card mb-3 border-0">
              <div className="card-body">
        ...
        <section className="container pb-5">
          ...
          <div className="container-fluid">
            ...
            <div className="row">
              ...
              <div className="col">
                <p className="fs-5 lh-1">Full Stack Developer</p>
                <p>
                  <b>Facebook</b>
                </p>
              </div>
              ...
              <div className="card  align-items-center pt-3 pb-1 bg-body-tertiary shadow ">
                <div className="container-fluid d-inline-flex gap-2 align-items-center">
                  ...
                  <p className="card-text lh-2">
                    <small className="text-body-secondary">
                      <strong className="text-black">João</strong>
                      <br />
                ...
                <div className="card-body text-center">
                  <p className="card-text">
                    ...
                    <em>
                      Foi ótima a minha esperiência com a plataforma. Conteúdo
                      didático e ótimas oportunidades de carreira.
                    </em>
                    <i className="bi bi-quote" />
                  </p>
                </div>
            ...
            <div className="col">
              <div className="card  align-items-center pt-3 pb-1 bg-body-tertiary shadow ">
                <div className="container-fluid d-inline-flex gap-2 align-items-center">
                  ...
                  <p className="card-text lh-2">
                    <small className="text-body-secondary">
                      <strong className="text-black">Ana Carolina</strong>
                      <br />
                      Last updated 3 mins ago
                    </small>
                  </p>
            ...
            <div className="col">
              <div className="card  align-items-center pt-3 pb-1 bg-body-tertiary shadow ">
                <div className="container-fluid d-inline-flex gap-2 align-items-center">
                  ...
                  <p className="card-text lh-2">
                    <small className="text-body-secondary">
                      <strong className="text-black">Carlos</strong>
                      <br />
                      Last updated 3 mins ago
                    </small>
                  </p>
            ...
            <div className="col">
              <div className="card align-items-center pt-3 pb-1 bg-body-tertiary shadow ">
                <div className="container-fluid d-inline-flex gap-2 align-items-center">
                  ...
                  <p className="card-text lh-2">
                    <small className="text-body-secondary">
                      <strong className="text-black">Maria</strong>
                      <br />
                      Last updated 3 mins ago
                    </small>
                  </p>
